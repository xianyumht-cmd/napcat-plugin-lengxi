...
| 指令 | 说明 | 示例 |
| :--- | :--- | :--- |
| `添加违禁词 <词语>` | 添加群内违禁词，触发自动撤回/禁言。 | `添加违禁词 兼职` |
| `删除违禁词 <词语>` | 删除违禁词。 | `删除违禁词 兼职` |
| `违禁词列表` | 查看本群违禁词。 | `违禁词列表` |
| `添加拒绝词 <词语>` | 添加**入群申请**拒绝关键词（如申请理由包含该词则拒绝）。 | `添加拒绝词 广告` |
| `删除拒绝词 <词语>` | 删除入群拒绝关键词。 | `删除拒绝词 广告` |
| `拒绝词列表` | 查看入群拒绝关键词。 | `拒绝词列表` |
